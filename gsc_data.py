...
site = 'https://www.cuddlynest.com'    # Property to extract
            ...
            while (status != 'Finished') : # Test with i < 10 just to see how long the task will take to process.
                ...
                #Process the response
                    for row in response['rows']:
                        ...
                        scDict['page'].append(row['keys'][1].encode('utf-8').strip() or 0)
                        scDict['query'].append(row['keys'][2].encode('utf-8').strip() or 0)
